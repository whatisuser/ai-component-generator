    ...
    <section className="rounded-[1.75rem] border border-[var(--border)] bg-[var(--panel)] p-5 shadow-[var(--shadow)] backdrop-blur sm:p-6">
      <div className="flex flex-col gap-4">
        ...
        <textarea
          ...
          disabled={isLoading}
          title={isLoading ? "Please wait for generation to complete" : undefined}
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
          ...
          <button
            ...
            title={isLoading ? "Please wait for generation to complete" : (!prompt.trim() ? "Enter a prompt to generate a component" : undefined)}
