          ...
          >
            {isLoading ? (
              ...
              <>
                ...
                <kbd className="hidden items-center gap-1 rounded border border-slate-700 bg-slate-800 px-1.5 py-0.5 text-[0.625rem] font-medium text-slate-300 sm:inline-flex">
