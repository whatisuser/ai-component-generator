      ...
      return (
        <div className="flex min-h-full items-center justify-center bg-slate-50 p-5">
          <div className="w-full max-w-lg rounded-3xl border border-rose-200 bg-white p-5 text-left shadow-sm">
            ...
            <pre className="mt-4 overflow-auto rounded-2xl bg-rose-50 px-4 py-3 font-mono text-sm text-rose-700">
      ...
      <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            title={!hasCode ? "Generate a component first to reload the preview" : isLoading ? "Wait for generation to complete" : undefined}
            className="rounded-full border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-700 transition hover:border-slate-300 hover:text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-60"
          >
            Reload preview
          </button>
          <button
