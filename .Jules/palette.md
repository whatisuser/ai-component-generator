...
## 2026-08-10 - Disabling submit button on empty input
**Learning:** Prevent validation errors by proactively disabling submit buttons when inputs are empty, accompanied by an explanatory native tooltip.
**Action:** Add disabled state and 'title' attribute to the submit button when the prompt input is empty to improve user guidance.
