...
## 2026-08-24 - Disable Inputs and Explain Disabled Buttons
**Learning:** Disabling interactive elements without explanation can leave users confused, and leaving inputs active during async operations can lead to data loss.
**Action:** Always disable text inputs during loading states and provide native title tooltips for disabled submit buttons to explain the missing input or application state.
