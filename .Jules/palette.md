...
## 2026-08-22 - Prevent interaction during loading & explain disabled states
**Learning:** Users can get confused if input fields aren't disabled during async operations, leading to lost edits. Additionally, disabling buttons without explanation is an accessibility anti-pattern.
**Action:** Always disable text inputs during loading states and provide a native `title` tooltip on disabled form submission buttons to explain the missing requirement.
