...
## 2026-05-07 - [Input Interaction Lock]
**Learning:** Even when buttons are disabled during loading states, users can often continue typing in active textareas, leading to disjointed states or discarded keystrokes if the form clears.
**Action:** Always disable associated input fields (e.g., `<textarea>`) alongside submit buttons during `isLoading` states for a cohesive interaction lock.
