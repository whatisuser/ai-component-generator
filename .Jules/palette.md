...
## 2026-08-07 - [Disable Generate Button When Empty]
**Learning:** Users can click the submit button with an empty prompt, which causes an unnecessary error state. Providing clear feedback (disabled state + tooltip) prevents this.
**Action:** Disabled the button and added a title attribute when the prompt is empty.
